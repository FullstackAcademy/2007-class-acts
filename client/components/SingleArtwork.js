        ...
        <div>
            <div>
                ...
                <div style={{display: "flex"}}>
                    <div style={{padding: "1rem", maxWidth:"40%", minWidth:"40%"}} /* Added inline temporary styling, to see how it looks*/>
                        <img src = {this.props.artwork.shopImages[0].imageURL} style={{maxWidth:"100%"}}/>
